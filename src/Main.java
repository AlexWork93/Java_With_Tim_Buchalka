...
//
//        -  addSong(), has two parameters of type String (title of song),
...
//        and returns a boolean. Returns true if it exists and it was added successfully
...
//
//        -  toString(), Songs overriding toString method.
//        Returns a String in the following format: "title: duration"
//
//
//
//->  SAMPLE INPUT
...
//
//
//TIP:  In Album, use the findSong() method in addSong()
// and addToPlayList(String, LinkedList) to check if a song exists before proceeding.
//
...
//
//NOTE:  If you get an error from the Evaluate class,
// it's most likely the constructor.
