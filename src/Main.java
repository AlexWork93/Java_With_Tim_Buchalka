...
//        will be updated with the new contact) and returns a boolean.
...
//
//        -  createContact(), has two parameters of type String
//        (the persons name and phone number) and returns an instance of Contact.
...
//
//NOTE:  All methods should be defined as public (except for the two findContact()
...
public class Main {
    public static void main(String[] args) {
        MobilePhone mobilePhone = new MobilePhone("123234345");
        System.out.println(mobilePhone.addNewContact(new Contact("qwerwertsdfg", "123412341234")));
        System.out.println(mobilePhone.addNewContact(new Contact("qwerwertsdfg", "123412341234")));
        mobilePhone.addNewContact(new Contact("asdfrtsdfg", "4562341234"));
        mobilePhone.addNewContact(new Contact("ertetyertsdfg", "34563412341234"));
