...
// This class will have two member variables of type int,
// tonerLevel and pagesPrinted, and one of type boolean called duplex.
...
// If this condition is met a second test must be included to test whether tonerLevel
// plus tonerAmount is greater than 100. If so, the method should return -1.
// If not then tonerLevel should have the incoming tonerAmount added to it
// and the new tonerLevel should then be returned by the method.
...
// If "true" then a calculation must be performed to determine the number
// of pages needed to print the job double sided.
...
//
//You can include a message in the printPages method which informs the user that
// the printer is printing in duplex mode if duplex is equal to "true" if you want.
//
//When calculating pagesToPrint if duplex is equal to "true" remember that
// there are two operators which can help you with this.
