...
// To complete the exercise, you must create five classes with associated member variables and methods.
//
...
// style of type String,
// and pillows, height, sheets, quilt of type int.
...
// ceiling of type Ceiling; bed of type Bed, and lamp of type Lamp.
...
// and makeBed() which prints a message that the bed is being made and also calls the
